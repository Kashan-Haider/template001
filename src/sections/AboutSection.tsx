...
export default function AboutSection({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 right-0 w-96 h-96 opacity-10 rounded-full blur-3xl animate-pulse"
        style={{
          background: theme
            ? `linear-gradient(135deg, ${theme.primaryColor}, ${theme.secondaryColor})`
            : "#000",
      ...
      ></div>
      <div
        className="absolute bottom-0 left-0 w-64 h-64 opacity-5 rounded-full blur-2xl animate-bounce"
        style={{
          background: theme
